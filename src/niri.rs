...
pub struct Niri {
    ...
    pub gesture_swipe_4f_cumulative: Option<(f64, f64)>,
    pub gesture_swipe_4f_horizontal: Option<bool>,
...
impl Niri {
    pub fn new(
        ...
        let mut niri = Self {
            ...
            gesture_swipe_4f_cumulative: None,
            gesture_swipe_4f_horizontal: None,
